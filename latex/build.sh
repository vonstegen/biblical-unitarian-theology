...
REVISION_SLUG="v1.3-phd-ch0"                  # v1.0 baseline; v1.1 re-grounds Ch 11/15 as a paired gate; v1.2 = full final-acceptance pass (all 17 chapters + appendices accepted); v1.3 = PhD expansion begins (Chapter 0 Methodology; Appendix A next)
